                ...
                <BootstrapModalForm ref="awsConfigModal"
                    ...
                    <fieldset>
                        ...
                        <Input type="checkbox"
                               ...
                               help={<span>When enabled, we'll access the AWS APIs through the HTTP proxy configured (http_proxy_uri) in your Graylog configuration file. Important: You might have to restart AWS message inputs for this configuration to take effect.</span>}
                               name="proxy_enabled"
