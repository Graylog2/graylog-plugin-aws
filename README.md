...
See the [Throttling Criteria](http://docs.graylog.org/en/3.0/pages/sending_data.html#throttling-criteria) section in the Graylog docs for more information on throttling. 